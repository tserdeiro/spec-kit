...
- [x] T002 [US2] Complete repeatable feature publication and handoff in presets/default/commands/pr.md
  ...
  - **Completion evidence**: Implementation ab49d54, including reviewed draft-command, Linear-evidence, failure-stop, and pre-push observation fixes. Product command tests: 8 passed; full preset suite: 79 passed; installed bundle conformance passed with synthetic providers. Budget: 96/400 authored executable lines; diff check clean. Actual-agent acceptance follows in T006; PR candidate review and CI gate readiness.

...
- [x] T002 [US2] Complete repeatable feature publication and handoff in presets/default/commands/pr.md
  ...
  - **Completion evidence**: Implementation 7928549, including reviewed publication retry/failure handling, every push target, gate identity, scoped staging, and stable Linear evidence. Product command tests: 8 passed; full preset suite: 79 passed; installed bundle conformance passed with synthetic providers. Budget: 134/400 authored executable lines; diff check clean. Actual-agent acceptance follows in T006; PR candidate review and CI gate readiness.

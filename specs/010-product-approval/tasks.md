...
- [x] T002 [US2] Complete repeatable feature publication and handoff in presets/default/commands/pr.md
  ...
  - **Completion evidence**: Implementation e46c0b8, including reviewed publication failure/retry, repository/base/head identity, and stable Linear-evidence fixes. Product command tests: 8 passed; full preset suite: 79 passed; installed bundle conformance passed with synthetic providers. Budget: 120/400 authored executable lines; diff check clean. Actual-agent acceptance follows in T006; PR candidate review and CI gate readiness.
